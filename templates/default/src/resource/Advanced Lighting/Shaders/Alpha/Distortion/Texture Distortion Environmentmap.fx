//====================================================
// Texture Refraction Environmentmap
//====================================================
// By EVOLVED
...
//--------------
   float4 PS(OutPut IN) : COLOR
	...
	return float4(lerp(Diffuse.xyz,texCUBE(CubeMapSampler,reflect(IN.ViewPos,IN.Normal)),ReflectFactor)*lerp(IN.Light1.xyz,IN.Light2,Diffuse.w*LightFactor),Diffuse.w*IN.Light1.w);
     }
