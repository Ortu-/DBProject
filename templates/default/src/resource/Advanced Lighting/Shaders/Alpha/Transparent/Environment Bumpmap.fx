...
//--------------
   ...
   struct OutPut
	...
	float4 Proj:TEXCOORD1;
  	...
  	float3 tbnRow1:TEXCOORD3;
  	float3 tbnRow2:TEXCOORD4;
  	float3 tbnRow3:TEXCOORD5;
...
//--------------
   float4 PS(OutPut IN) : COLOR
	...
	return float4(lerp(Diffuse,Reflection,ReflectFactor)*lerp(IN.Light1.xyz,IN.Light2,Diffuse.w*LightFactor),Diffuse.w*IN.Light1.w);
     }
