...
//--------------
   Out_AboveWater VS_AboveWater(In_AboveWater IN) 
	...
	float ClampUvOffset=WaterIndex2[IN.Index1.y].y;
	float FlipUvOffset=WaterIndex2[IN.Index1.y].x;
	float2 UvOffset1=(float2(0,-1*MaxUvOffset)+(float2(IN.Tex1.y,lerp(IN.Tex1.x,-IN.Tex1.x,FlipUvOffset))*ClampUvOffset)*WaterIndex3[IN.Index3.x].y)/WaterSize.xy;
	float2 UvOffset2=(float2(0,1*MaxUvOffset)+(float2(IN.Tex2.y,lerp(IN.Tex2.x,-IN.Tex2.x,FlipUvOffset))*ClampUvOffset)*WaterIndex3[IN.Index3.x].y)/WaterSize.xy;
	...
	float LerpHeight=saturate(WaterIndex2[IN.Index1.y].w+WaterIndex3[IN.Index3.x]);
