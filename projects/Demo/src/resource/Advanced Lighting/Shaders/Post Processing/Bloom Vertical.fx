...
//--------------
   OutPut VS(InPut IN) 
	...
	OUT.Pos=IN.Pos; 
 	...
 	OUT.Tex1.xy=OUT.Tex+float2(0,ViewVec.y)*2;
 	OUT.Tex1.zw=OUT.Tex+float2(0,ViewVec.y*2)*2;
 	OUT.Tex2.xy=OUT.Tex+float2(0,ViewVec.y*3)*2;
 	OUT.Tex2.zw=OUT.Tex+float2(0,ViewVec.y*4)*2;
 	OUT.Tex3.xy=OUT.Tex+float2(0,ViewVec.y*5)*2;
 	OUT.Tex3.zw=OUT.Tex+float2(0,ViewVec.y*6)*2;
 	OUT.Tex4.xy=OUT.Tex+float2(0,ViewVec.y*7)*2;
 	OUT.Tex4.zw=OUT.Tex-float2(0,ViewVec.y)*2;
 	OUT.Tex5.xy=OUT.Tex-float2(0,ViewVec.y*2)*2;
 	OUT.Tex5.zw=OUT.Tex-float2(0,ViewVec.y*3)*2;
 	OUT.Tex6.xy=OUT.Tex-float2(0,ViewVec.y*4)*2;
 	OUT.Tex6.zw=OUT.Tex-float2(0,ViewVec.y*5)*2;
 	OUT.Tex7.xy=OUT.Tex-float2(0,ViewVec.y*6)*2;
 	OUT.Tex7.zw=OUT.Tex-float2(0,ViewVec.y*7)*2;
	return OUT;
    }
